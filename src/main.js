...
const GROUND_LEVEL = 2000;
const LEAVE_THRESHOLD = GROUND_LEVEL - 1800; // auto leave planet when above this
const LAND_DISTANCE = 80; // how close to planet center to auto-land
...
const ALIEN_SKINS = ALIEN_RACES.flatMap(r => r.skins);
...
const WATER_DEPTH = 2500; // how deep the ocean goes below GROUND_LEVEL
const WATER_SURFACE = 2000; // same as GROUND_LEVEL
const SEABED_Y = 2000 + 2500; // GROUND_LEVEL + WATER_DEPTH
